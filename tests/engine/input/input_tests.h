...
class InputTest : public ::testing::Test
{
  public:
    ...
    StevensDev::sgdi::Input                 &d_in;
      // Instance of the Input singleton
...
TEST_F( InputTest, IsDown )
{
    #define INPUT_MOUSE( key )                                             \
        EXPECT_FALSE( d_in.isDown( StevensDev::sgdi::InputType::MOUSE_##key ) );

    #define INPUT_KEY( key )                                               \
        EXPECT_FALSE( d_in.isDown( StevensDev::sgdi::InputType::KEY_##key ) );
